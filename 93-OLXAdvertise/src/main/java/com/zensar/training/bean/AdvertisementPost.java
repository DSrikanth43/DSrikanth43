...
public class AdvertisementPost {
	...
	@Embedded
	private AdvertisementPost advertisementStatus;
	...
	public AdvertisementPost(String title, String description, double price, Category category, OLXUser olxUser,
			AdvertisementPost advertisementStatus, String createdDate, String modifiedDate, byte[] photo) {
		super();
		this.title = title;
	...
	public AdvertisementPost getAdvertisementStatus() {
		return advertisementStatus;
	}

	public void setAdvertisementStatus(AdvertisementStatus advertisementStatus2) {
		this.advertisementStatus = advertisementStatus;
	}
